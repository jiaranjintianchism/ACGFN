...
from model.acgfn_block import ACGFNBlock
from model.config import Config
from model.self_attention import PositionalEncoder


class ACGFNEncoder(nn.Module):
    def __init__(self, config: Config):
        ...
        self.layers = nn.ModuleList([ACGFNBlock(config) for _ in range(config.num_hidden_layers)])
